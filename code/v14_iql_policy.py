...
pickle_path = '../training_dataset_pickle/true_training_dataset_picklev4.pickle'
# evaluation_dataset_path = '../ALLdatasets/evaluate'
evaluation_dataset_path = '../ALLdatasets/emulated_dataset_policy'
...
def get_input_from_file():
    ...
    evaluation_file = '../data/02560.json'
